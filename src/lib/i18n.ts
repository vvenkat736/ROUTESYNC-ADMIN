...
export const translations = {
  en: {
    ...
    route_optimizer_desc: 'Find the best route and ETA between multiple points.',
  ...
  ta: {
    ...
    route_optimizer: 'வழித்தட உகப்பாக்கி',
    route_optimizer_desc: 'பல புள்ளிகளுக்கு இடையே சிறந்த வழி மற்றும் ETA ஐக் கண்டறியவும்.',
